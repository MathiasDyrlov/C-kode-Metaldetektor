...
int main(){
    ...
    uint32_t amplitude = 0, amplitude1 = 0;  // To store the calculated amplitude (for DFT approximation)
    float phase = 0.0, phase1 = 0.0;       // To store the calculated phase (for DFT approximation)
 ...
 while (1) {
    ...
    {   
        ...
        if (buffer_full == true) {
            ...
            amplitude1=amplitude1-amplitude_calibrate; // calibration subtravted from current result
